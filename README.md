**goit-js-hw-10 ** _Модуль 10 -Взаємодія з бекендом._
...
![message](/src/img/too-many-matches.png)
...
![message](/src/img/country-list.png)
...
![message](/src/img/country-info.png)
...
![message](/src/img/error-alert.png)

**ВНИМАНИЕ**

Не забывай о том, что fetch не считает 404 ошибкой, поэтому необходимо явно
